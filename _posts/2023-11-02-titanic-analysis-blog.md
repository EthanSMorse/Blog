...
This is where tha=e data that I was told to work with comes in. We were provided a data set, with which many questions could be both asked and answered. The graph below is accurate data from the sinking of the Titanic.
